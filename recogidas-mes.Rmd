...
```{r, echo=FALSE}
ggplot()+geom_line(data=recogidas, aes(x=Mes,y=cumsum(Recogidas),color=Año,group=Año))
```

En este gráfico se muestra el acumulado por año, con fin de comparar lo recogido cada año con el anterior.

```{r, echo=FALSE}
ggplot()+geom_line(data=subset(recogidas,Año==2012), aes(x=Mes,y=cumsum(Recogidas),color=Año,group=Año))+geom_line(data=subset(recogidas,Año==2013), aes(x=Mes,y=cumsum(Recogidas),color=Año,group=Año))+geom_line(data=subset(recogidas,Año==2014), aes(x=Mes,y=cumsum(Recogidas),color=Año,group=Año))+geom_line(data=subset(recogidas,Año==2015), aes(x=Mes,y=cumsum(Recogidas),color=Año,group=Año))
